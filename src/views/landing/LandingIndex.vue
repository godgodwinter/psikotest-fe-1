...
<template>
  ...
  >
    ...
    <div
      class="font-extrabold text-[40px] lg:text-[130px] text-transparent bg-clip-text bg-gradient-to-br from-sky-400 to-slate-900 lg:indent-16 text-center"
    >
      PSIKOTEST.
    </div>
    ...
    <div class="flex justify-center gap-4 flex-wrap">
      <router-link :to="{ name: 'LandingLogin' }">
        <ButtonTwo title="LOGIN"></ButtonTwo
      ></router-link>
    </div>
  </div>
