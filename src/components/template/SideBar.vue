...
<template>
  <aside
    ...
    id="sidebar"
    class="fixed z-20 h-full top-0 left-0 pt-16 flex lg:flex flex-shrink-0 flex-col w-64 lg:w-72 border transition-width duration-75"
    aria-label="Sidebar"
  >
    <div
        ...
        <div class="flex-1 px-3 bg-white divide-y space-y-1">
          ...
          >
            ...
            <li class="bg-white lg:w-full flex justify-center">
              <button
                @click="goLogout()"
                class="text-base text-gray-900 font-normal rounded-lg flex items-center p-2 hover:bg-gray-100 group border border-2 border-slate-400 hover:border-slate-500"
              >
                <svg
